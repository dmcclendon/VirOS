...
repo --name=released --baseurl=http://mirrors1.kernel.org/fedora/releases/11/Everything/i386/os
### viros: experiment? should not be necessary to hide this but...
###repo --name=updates --baseurl=http://mirrors1.kernel.org/fedora/updates/11/i386
...
# System services
### todo: really simple to move to traits
...
# add compat live user with no passwd
...
-vino
-vorbis-tools
# VirOS: wget is pretty important
#-wget
wget
-words
-xsane
