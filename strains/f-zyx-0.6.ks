...
###repo --name=updates --baseurl=http://mirrors1.kernel.org/fedora/updates/13/i386
...
@hardware-support
@input-methods
# experiment, this was in spin-kickstarts version, but seemingly not the released live iso
# @ o f f i c e
@printing
@sound-and-video
anaconda
